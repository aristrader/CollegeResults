...
import org.collegeWorks.collegeresults.v1.services.CollegeServiceV1;
...
@Slf4j
@RestController
@RequestMapping(PathConstants.COLLEGES_PATH_V1)
public class CollegeControllerV1 {

  @Autowired
  CollegeServiceV1 collegeService;

  @PostMapping(PathConstants.ADD)
  public ResponseEntity<RestResponse> insertColleges(
      @Valid @RequestBody CollegeRequestV1 collegeRequest)
      throws ServiceException {
    log.info("[CollegeControllerV1] Received request to insert college {}", collegeRequest);
  ...
  public ResponseEntity<RestResponse> getCollegeWithNameAndAddress(
      ...
      throws ServiceException {
    log.info(
        "[CollegeControllerV1] Received the request for finding college with name {} and address {}",
        name, address);
    RestResponse response = RestResponse.successResponse(
  ...
  public ResponseEntity<RestResponse> getCollegesWithName(
      ...
      throws ServiceException {
    log.info(
        "[CollegeControllerV1] Received the request for finding colleges with name {}",
        name);
    RestResponse response = RestResponse.successResponse(
