...
public class CollegeEntityV1 {
  ...
  private Set<StudentEntityV1> students;  // A set of students associated with the college, will only be fetched when explicitly called.
}
