...
public class CollegesController {
  ...
  public ResponseEntity<RestResponse> insertColleges(@Valid @RequestBody CollegeRequest collegeRequest)
    ...
    RestResponse response = RestResponse.successResponse(String.format("The college has been successfully inserted with id : %d", collegeIdCreated));
  ...
  // Get the college with the exact name and address.
  // Simply return the single college
